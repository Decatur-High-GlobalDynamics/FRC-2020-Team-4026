...
public class VerticalIndexerSubsystem extends SubsystemBase {
  ...
  private DigitalInput bottomSwitchA =
      new DigitalInput(Constants.VerticalIndexer_BottomLimit_DIO_A);
  private DigitalInput bottomSwitchB =
      new DigitalInput(Constants.VerticalIndexer_BottomLimit_DIO_B);
  private DigitalInput bottomSwitchC =
      new DigitalInput(Constants.VerticalIndexer_BottomLimit_DIO_C);
