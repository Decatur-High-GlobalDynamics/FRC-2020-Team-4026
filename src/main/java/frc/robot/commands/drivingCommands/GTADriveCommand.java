...
public class GTADriveCommand extends CommandBase {
  ...
  public void execute() {
    ...
    //This feeds the powers to curve drive - the power, the turn, which is leftStick's value, and whether power is below a threshold - if it is we assume we're turning in place
