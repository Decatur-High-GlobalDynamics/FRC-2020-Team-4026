...
/**TODO in the future: make this better, I want to have real pathing once pathfinding is a thing, instead of turning in place then going forwards*/
...
public class HunterKillerCommand extends CommandBase {
  ...
  /** Creates a new HunterKillerCommand. Assumes that the camera is fixed to the drivetrain, oriented forward*/
  public HunterKillerCommand(
      DriveTrainSubsystem driveTrain, NavigationSubsystem nav, DoubleSupplier joystick, VisionSubsystem vision) {
