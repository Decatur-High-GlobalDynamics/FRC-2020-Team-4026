...
public class UpdateNavigationCommand extends CommandBase {
  ...
  public UpdateNavigationCommand(
      NavigationSubsystem nav, DoubleSupplier leftEncode, DoubleSupplier rightEncode) {
    navSystem = nav;
  ...
  // This just updates position. Vision and stuff should be added here (i.e. this can query vision
  // and if it exists do that after it updates pose normally)
  @Override
  public void execute() {
